...
The one genuine cost-of-control result in the source material is a purely
\emph{experimental} control-norm blow-up as the control region $\omega$
shrinks. No exponential-in-$\varepsilon$ blow-up result (of the form
$k\sim e^{1/\varepsilon}$, sometimes seen in the wider numerical HUM
literature) is established in the source material used here, and none is
claimed.
